...
>
    ...
    >
        ...
        <div
            class="lqd-cs-canvas-container-wrap max-w-screen col-start-1 col-end-1 row-start-1 row-end-1 grid h-screen max-h-screen w-screen select-none grid-cols-1 place-items-center overflow-hidden"
            x-ref="editorCanvasWrap"
        >
            <div
                class="lqd-cs-canvas-container col-start-1 col-end-1 row-start-1 row-end-1 grid h-full max-h-full min-h-full w-full min-w-full max-w-full select-none grid-cols-1 place-items-center overflow-hidden transition-colors focus:outline-none [&_.konvajs-content]:w-full [&_.konvajs-content]:translate-x-[--zoom-offset-x] [&_.konvajs-content]:translate-y-[--zoom-offset-y] [&_.konvajs-content]:scale-[--zoom-level]"
