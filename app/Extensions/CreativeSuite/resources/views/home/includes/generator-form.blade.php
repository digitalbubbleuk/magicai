<div class="lqd-adv-img-editor-form-wrap pb-6 pt-16">
    ...
    <form
        class="lqd-adv-img-editor-form relative flex min-h-16 w-full flex-wrap rounded-full bg-background/60 font-medium shadow-lg shadow-black/5 dark:bg-input-background/10 sm:text-2xs lg:flex-nowrap"
        method="POST"
    ...
    >
        ...
        <x-forms.input
            ...
            class="h-auto appearance-none rounded-s-full border-none bg-transparent py-0 pe-8 ps-8 text-heading-foreground/90"
            id="image_generator"
            type="select"
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('advancedImageEditorForm', () => ({
                ...
                handleFiles(files) {
                    ...
                    if (this.generator === 'stable_diffusion') return;
                ...
                onFormSubmit() {
                    ...
                    if (templateInput.val()) {
                        ...
                        if (image) {
                            ...
                            if (gene !== 'gpt-image-1' && gene !== 'flux-pro-kontext' && gene !== 'stable_diffusion') {
