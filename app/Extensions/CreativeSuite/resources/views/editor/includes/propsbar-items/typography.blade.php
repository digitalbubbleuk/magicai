...
>
    ...
    >
        <button
            class="flex w-full min-w-56 cursor-pointer items-center justify-between gap-1 rounded-xl border border-black/5 px-2 py-3 text-2xs/none font-medium text-black/90 transition-all hover:bg-black/[2%]"
            type="button"
    ...
    >
        ...
        <input
            class="col-start-1 col-end-1 row-start-1 row-end-1 w-full appearance-none rounded-xl border border-foreground/10 bg-transparent py-0.5 pe-1 ps-6 text-2xs transition-all focus:border-primary focus:outline-none group-[&.dragging]:border-primary"
            x-ref="dynamicInput"
        >
    </div>
