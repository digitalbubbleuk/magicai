        ...
        <div class="grid grow grid-cols-2 gap-1">
            ...
            >
                ...
                <input
                    ...
                    @input="handleStageResize({width: $event.target.value, preserveAspectRatio})"
                >
            </div>
            <div
                class="group relative flex w-20 min-w-full font-semibold uppercase"
            ...
            >
                ...
                <input
                    ...
                    @input="handleStageResize({height: $event.target.value, preserveAspectRatio})"
                >
            </div>
        </div>
        ...
        @foreach ($sizes as $key => $size)
            <li class="flex flex-col">
                <button
                    ...
                    type="button"
                    @click.prevent="handleStageResize({ width: {{ $size['width'] }}, height: {{ $size['height'] }} })"
                >
                    {{ $size['label'] }}
