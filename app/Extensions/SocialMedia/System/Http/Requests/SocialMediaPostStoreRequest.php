...
class SocialMediaPostStoreRequest extends FormRequest
{
    ...
    {
        $limit = config('social-media.' . $this->get('social_media_platform') . '.requirements.text.limit');

        $imageRule = $this->get('social_media_platform') === PlatformEnum::instagram->value ? 'required' : 'sometimes';
